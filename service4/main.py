...
def predict(data: predictTransactions):
    ...
    #features = np.array([[data.TransactionID, data.TransactionAmt, data.ProductCD, data.card1, data.card2, data.card3, data.card4, data.card5, data.card6, data.addr1, data.addr2, data.P_e>
